...
import "./EinladungsMailer.scss"

import Einladungsformular from "./Einladungsformular"



const EinladungsMailer = () => {
  ...
  return (
    <section id="mitgliederbereich-section" className="section-b">
      <Container>
        <Row>
          <Col md={12}>
            <h1>
        ...
        {logged
        ? <Einladungsformular name={_profile.name} email={_profile.email} sendMailHandler={sendMailHandler}/>
        : <Row>
            <Col md={12}>
              <SocialButton
                provider="facebook"
...
export default EinladungsMailer
